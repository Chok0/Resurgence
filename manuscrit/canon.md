...
- **Densification (2ᵉ passe — en cours, ch.1 fait)** : appliquer à ch.2-7 les **garde-fous 15-16** — **incarnation concrète** (corps, choses, visages : on doit *voir* une scène) et **peur en Phase 1** (le bestiaire + le moteur creepypasta : les Salles de l'Oubli du ch.2 doivent **faire peur**, pas être muséales). **Reconcilier avec la vraie mission (contrôle de la mémoire)** : ch.2 « expurgation d'usage » et ch.6 trou des métadonnées sont les **traces de la suppression** (à lire comme la mission, non comme un incident) ; ch.4-7, **le moine copiste = résister à l'effacement**. Garde-fous : [`regles-ecriture.md`](regles-ecriture.md).
